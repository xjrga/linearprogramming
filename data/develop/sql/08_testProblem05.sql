...
CALL LinearProgramming.addCoefficient(12);
...
CALL LinearProgramming.addCoefficient(10);
CALL LinearProgramming.addCoefficient(2);
CALL LinearProgramming.addCoefficient(1);
CALL  LinearProgramming.addLinearConstraint(1,2,100);
--
CALL LinearProgramming.addCoefficientSpace(2);
CALL LinearProgramming.setCoefficientSpace(2);
CALL LinearProgramming.addCoefficient(7);
CALL LinearProgramming.addCoefficient(3);
CALL LinearProgramming.addCoefficient(2);
CALL  LinearProgramming.addLinearConstraint(2,2,77);
--
